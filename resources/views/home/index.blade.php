                        ...
                        <ul class="nav">
                            @foreach($categories[0] as $categoryTop)
                                <li class="dropdown menu-item">
                                    <a href="{{ url('product',$categoryTop->id) }}" class="dropdown-toggle"
                                       data-toggle="dropdown">{{ $categoryTop->name }}</a>
                                                    ...
                                                    @foreach($categories[$categoryTop->id] as $categorySecond)
                                                        <div class="col-md-4">
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    <a href="{{ url('product',$categorySecond->id) }}"><b>{{ $categorySecond->name }}</b></a>
                                                                </li>
                                                                <!--三级分类-->
                                                                @if(isset($categories[$categorySecond->id]))
                                                                    @foreach($categories[$categorySecond->id] as $categoryThird)
                                                                        <li>
                                                                            <a href="{{ url('product',$categoryThird->id) }}">{{ $categoryThird->name }}</a>
                                                                        </li>
                                                                    @endforeach
                                                                @endif
            ...
            <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder">
                ...
                <div id="hero">
                    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                        ...
                        <div class="item"
                             style="background-image: url({{ asset('static/frontend') }}/assets/images/sliders/111.jpg);">
                        </div><!-- /.item -->

                        <div class="item"
                             style="background-image: url({{ asset('static/frontend') }}/assets/images/sliders/222.jpg);">
                        </div><!-- /.item -->
        ...
        <div class="container">
            <div class="col-xs-12 col-lg-6 no-margin banner">
                <a href="category-grid-2.html">
                    ...
                    <img class="banner-image" alt="" src="{{ asset('static/frontend') }}/assets/images/blank.gif"
                         data-echo="{{ asset('static/frontend') }}/assets/images/banners/banner-narrow-01.jpg"/>
                </a>
            </div>
            <div class="col-xs-12 col-lg-6 no-margin text-right banner">
                <a href="category-grid-2.html">
                    ...
                    <img class="banner-image" alt="" src="{{ asset('static/frontend') }}/assets/images/blank.gif"
                         data-echo="{{ asset('static/frontend') }}/assets/images/banners/banner-narrow-02.jpg"/>
                </a>
            </div>
        </div><!-- /.container -->
