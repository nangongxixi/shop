        ...
        <header>
            <div class="container no-padding">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    ...
                    <div class="logo">
                        <a href="index.html">
                            <img alt="logo" src="{{ asset('static/frontend') }}/assets/images/logo.png" width="233"
                                 height="54"/>
                        <!--<object id="sp" type="image/svg+xml" data="{{ asset('static/frontend') }}/assets/images/logo.svg" width="233" height="54"></object>-->
                        </a>
                    </div><!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= -->
                </div><!-- /.logo-holder -->
                                ...
                                <ul class="categories-filter animate-dropdown">
                                    <li class="dropdown">
                                        ...
                                        <a class="dropdown-toggle" data-toggle="dropdown"
                                           href="category-grid.html">所有分类</a>
                            ...
                            <div class="basket">
                                ...
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    <div class="basket-item-count">
                                        ...
                                        <img src="{{ asset('static/frontend') }}/{{ asset('static/frontend') }}/assets/images/icon-cart.png"
                                             alt=""/>
                                    </div>
                                        ...
                                        <div class="basket-item">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                    <div class="thumb">
                                                        <img alt=""
                                                             src="{{ asset('static/frontend') }}/{{ asset('static/frontend') }}/assets/images/products/product-small-01.jpg"/>
                                                    </div>
                                                </div>
                ...
                <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-6 no-margin">
                        <div class="payment-methods ">
                            <ul>
                                <li><img alt=""
                                         src="{{ asset('static/frontend') }}/{{ asset('static/frontend') }}/assets/images/payments/payment-visa.png">
                                </li>
                                <li><img alt=""
                                         src="{{ asset('static/frontend') }}/{{ asset('static/frontend') }}/assets/images/payments/payment-master.png">
                                </li>
                                <li><img alt=""
                                         src="{{ asset('static/frontend') }}/{{ asset('static/frontend') }}/assets/images/payments/payment-paypal.png">
                                </li>
                                <li><img alt=""
                                         src="{{ asset('static/frontend') }}/{{ asset('static/frontend') }}/assets/images/payments/payment-skrill.png">
                                </li>
                            </ul>
                        </div><!-- /.payment-methods -->
                    </div>
