                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="#" class="thumb-holder">
                                        <img alt="" src="{{ asset('static/frontend') }}/assets/images/blank.gif"
                                             data-echo="{{ asset('static/frontend') }}/assets/images/products/product-small-01.jpg">
                                    </a>
                                </div>
                        ...
                        <li class="sidebar-product-list-item">
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="#" class="thumb-holder">
                                        <img alt="" src="{{ asset('static/frontend') }}/assets/images/blank.gif"
                                             data-echo="{{ asset('static/frontend') }}/assets/images/products/product-small-02.jpg">
                                    </a>
                                </div>
                                <div class="col-xs-8 col-sm-8 no-margin">
                        ...
                        <li class="sidebar-product-list-item">
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="#" class="thumb-holder">
                                        <img alt="" src="{{ asset('static/frontend') }}/assets/images/blank.gif"
                                             data-echo="{{ asset('static/frontend') }}/assets/images/products/product-small-03.jpg">
                                    </a>
                                </div>
                                <div class="col-xs-8 col-sm-8 no-margin">
                                    <a href="#">PowerShot Elph 115 16MP Digital Camera</a>
                                        ...
                                        @forelse($products as $product)
                                            <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                                <div class="product-item">
                                                    ...
                                                    <div class="image">
                                                        <img alt=""
                                                             src="{{ asset('static/frontend') }}/assets/images/blank.gif"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="result-counter">
                                                当前第 <span>{{ $products->currentPage() }}</span> 页， 共
                                                <span>{{ $products->total() }}</span>条商品
                                            </div>
                                        </div>
