    ...
    <div id="single-product">
        <div class="container">
                ...
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="owl-single-product">
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto"
                               href="images/products/product111.jpg">
                                <img class="img-responsive" alt=""
                                     src="{{ asset('static/frontend') }}/assets/images/products/product111.jpg"
                                     data-echo="{{ asset('static/frontend') }}/assets/images/products/product111.jpg"/>
                            </a>
                    ...
                    <div class="single-product-gallery-thumbs gallery-thumbs">
                        ...
                        <div id="owl-single-product-thumbnails">
                            ...
                            <a class="horizontal-thumb"
                               data-target="#owl-single-product" data-slide="2"
                               href="#slide3">
                                <img width="67" alt=""
                                     src="{{ asset('static/frontend') }}/assets/images/products/product111.jpg"
                                     data-echo="{{ asset('static/frontend') }}/assets/images/products/product111.jpg"/>
            ...
            <div class="no-margin col-xs-12 col-sm-7 body-holder">
                <div class="body">
                    <div class="title"><a
                                href="{{ url('product') }}">{{ $product->name }}</a>
                    </div>
                    <div class="brand">苹果笔记本</div>

                    <div class="excerpt">
                        <p>Apple MacBook Air 13.3英寸笔记本电脑 银色(Core i5 处理器/8GB内存/128GB
                            SSD闪存 MMGF2CH/A)</p>
                    </div>

                    <div class="prices">
                        <div class="price-current">￥ {{ $product->name }} </div>
                    ...
                    <div class="qnt-holder product-detail">
                        <div class="le-quantity">
                            <form>
                                ...
                                <input id="inputQty" name="quantity" readonly="readonly" type="text"
                                       value="1"/>
                                <a class="plus" href="#add"></a>
                            </form>
                        </div>
                        <a id="addto-cart" href="javascript:;"
                           class="le-button huge">加入购物车</a>
                    </div><!-- /.qnt-holder -->
                </div><!-- /.body -->
            ...
            <div class="tab-holder">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="description">
                        {{ $product->description->content ? $product->description->content:'暂无介绍' }}
